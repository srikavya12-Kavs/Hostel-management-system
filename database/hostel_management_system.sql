...
INSERT INTO `Application` VALUES (4,'221FA20011',3,0,1,''),(5,'221FA20012',4,0,1,''),(6,'221FA20018',5,0,1,''),(7,'221FA20019',6,0,1,''),(8,'221FA20020',1,0,2,''),(10,'221FA20021',1,0,3,''),(16,'221FA20022',1,0,1,'');
...
INSERT INTO `Application_mess` VALUES (2,'221FA20022',1,0,1,''),(3,'221FA20031',2,0,1,''),(4,'221FA20011',3,0,1,''),(5,'221FA20012',4,0,1,''),(6,'221FA20018',5,0,1,''),(7,'221FA20019',6,0,1,''),(8,'221FA20020',1,0,2,''),(9,'221FA20010',2,0,2,'I prefer this mess'),(10,'221FA20033',1,0,3,'');
...
INSERT INTO `Hostel` VALUES (1,'N2',3,5,3),(2,'MAIN',0,5,0),(3,'DELIGHT',1,5,1),(4,'GALAXY',1,5,1),(5,'AC',1,5,1),(6,'ELITE',1,5,1);
...
INSERT INTO `Hostel_Manager` VALUES (1,'kavya','Admin','VFSTR','987654321',1,1,'12345',1),(2,'hostelN2','Hostel','N2','987654321',1,1,'$2y$10$QImNrErR0Bj5Ns9Gm/CKbulEPWNj9YBpihk6JWg4Ipx.pcEev6gHq',0),(3,'hostelMAIN','Hostel','MAIN','987654321',2,2,'$2y$10$Xdfrgvx5EvVWMzfzwIyTb./igun.DZMp5XxBXWnME5s0IjtGgovDu',0),(4,'hostelDELIGHT','Hostel','DELIGHT','987654321',3,3,'$2y$10$7gpP8Q.krVUgulRBgxNOVejLPZN5PEEIoQr9xijdgDzeu9jvcpu5G',0),(5,'hostelGALAXY','Hostel','GALAXY','987654321',4,4,'$2y$10$inWxU5AcKQ8fLeufr6dYaeeLuvnhlh.N67XzqM4rZtg.xOsDWcBHu',0),(6,'hostelAC','Hostel','AC','987654321',5,5,'$2y$10$SpCXnzzahlCPOIVl2Eh1fePaUPtrpdAkvtrUXzF7W0xyusZS7nx/q',0),(7,'hostelELITE','Hostel','ELITE','987654321',6,6,'$2y$10$8b849FWoiZkfa5uRK52jYulD0llS6hOdkw7Srh0TQJO/JoVQvmLSi',0);
...
INSERT INTO `Mess` VALUES (1,'N2','Veg',2,5),(2,'MAIN','Veg',3,5),(3,'DELIGHT','Veg',5,5),(4,'GALAXY','Non-veg',4,5),(5,'AC','Non-veg',4,5),(6,'ELITE','Non-veg',4,5);
...
INSERT INTO `Payment` VALUES ('221FA20011',1,75000),('221FA20012',1,75000),('221FA20013',1,75000),('221FA20014',1,75000),('221FA20015',1,75000),('221FA20016',1,75000),('221FA20017',1,75000),('221FA20018',1,75000),('221FA20019',1,75000),('221FA20020',1,75000);
...
INSERT INTO `Student` VALUES ('221FA20011','Meghna','chowdary','9880921333','CSBS','2','$2y$10$ZCjLQHt.LgDyaUfrIfa2AObpPYXTYwxQ59FcHoM66K7J1PETUiiL.',1,1,1,1),('221FA20012','Ram','Krishna','9880921333','AIML','2','$2y$10$AO9Ffk4G..fkX1LvEChZDewF5Gh/D6iAQIY0TZHWsa2vzzdFhkBLW',NULL,NULL,2,1),('221FA20013','Mohit','M','9880921333','CS','4','$2y$10$hcUD0a5lNyEdx.TOhh1KpemwBhKrRs6tKHT.EcbeMqSDLQzRXcwjS',3,1,NULL,NULL),('221FA20014','Nive','Girisha','9880921333','IT','1','$2y$10$soAPlxnvKXAY7FJzFM7NPeaMk74RYU71iGrgyCvnFL3zho9Sc/POW',4,1,4,1),('221FA20015','Janavi','N','9880921333','ECE','2','$2y$10$59WQd4lgBJOXQ4pCrmKDeePCCdrEAi1eg8Rz.3saKuTBrTAdWuD5K',5,1,5,1),('221FA20016','Jhansi','reddy','9880921333','Civil','3','$2y$10$xxYP7aOEe.SVkgO0VPXhie8g8UzJDi5sspRunPD3VxlogPJ0zfd.G',6,1,6,1),('221FA20017','Mounika','P','9880921333','EEE','2','$2y$10$JbdyCLiYQn7.8UhXyqEkTeP0Kb5Lqh6X75CRXYFdEvmGW6aHrkmJW',NULL,NULL,2,2),('221FA20018','lasya','Sree','9880921333','ECE','3','$2y$10$LLmQJb7moIL2AAETKZ.cUe7Cwxfj/31Lt1GVktlfbAI72qBqxxKCu',1,2,1,2),('221FA20019','kamakshi','thai','9880921333','CS','4','$2y$10$Lsjw2Qesdb/YEH0u9y/tNe8DOH64Ievuh8hyivY9BdWY6LieXEBAG',1,3,1,3),('221FA20020','sai','lakshmi','9880921333','Mechanical','4','$2y$10$3ayzQhemDWUQTR5osk.SPOoZNppa2vte.p2brk86aSTC0t9DWaXKq',NULL,NULL,NULL,NULL);
...
CREATE TABLE `Attendance` (
  ...
  `Student_id` varchar(255) NOT NULL,
  `Date` date NOT NULL,
  `Status` tinyint(1) DEFAULT NULL, -- 1 for present, 0 for absent
...
(1, '221FA20011', '2024-09-01', 1),
(2, '221FA20012', '2024-09-01', 0),
(3, '221FA20018', '2024-09-01', 1),
(4, '221FA20019', '2024-09-01', 1),
(5, '221FA20020', '2024-09-01', 0);
UNLOCK TABLES;
